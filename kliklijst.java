...
//                            System.out.println("extensie is ok");
                            break;
                        }
                    }
...
//            Object keuze = e.getComponent();
            File keuzeFile = jButtonPressed.getLeftFile();
            try {
                Image imageToBeDisplayed = ImageIO.read(keuzeFile);
//                diaFrame.addMouseListener(new clickListener());
//                widthImageToBeDisplayed = imageToBeDisplayed.getWidth(diaFrame.getContentPane());
                widthImageToBeDisplayed = imageToBeDisplayed.getWidth(null);
//                heightImageToBeDisplayed = imageToBeDisplayed.getHeight(diaFrame.getContentPane());
